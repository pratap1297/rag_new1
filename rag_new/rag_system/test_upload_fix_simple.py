#!/usr/bin/env python3
"""
Simple test script to verify that upload fix preserves original filenames
"""
...
def test_upload_fix_simple():
    """Test that upload fix preserves original filenames with a simple text file"""
    
    print("🧪 Testing Upload Fix (Simple)")
    print("=" * 50)
    ...
    text_content = """Manager Roster Information
...
This information is from the Manager Roster document."""
    ...
    original_filename = "Manager_Roster_2024.txt"
    upload_metadata = {
